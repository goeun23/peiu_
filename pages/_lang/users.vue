				...
				<table class="data_table center">
					<tbody>
						<tr>
							<th>성</th>
							<td>
								<input v-model="profile_user_lastName" placeholder="홍" type="text">
							</td>
						</tr>
						<tr>
							<th>이름</th>
							<td>
								<input v-model="profile_user_firstName" placeholder="길동" type="text">
							</td>
						</tr>
						<tr>
							<th>Email *</th>
							<td>
								<input
									...
									placeholder="user@power21.co.kr"
									required="required"
									type="text"
									@change="verifyEmail()"
									ref="email"
						...
						<tr>
							<th>회사명 *</th>
							<td>
								<input v-model="profile_user_company" placeholder="파워이십일" type="text">
							</td>
						</tr>
						<tr>
							<th>Password *</th>
						...
						<tr>
							...
							<td>
								<input
									type="text"
									id="input_addr"
									placeholder="대전 유성구 테크노3로 65"
									v-model="profile_user_address1"
								>
						...
						<tr>
							<th>상세 지역</th>
							<td>
								<input type="text" id="input_addr" placeholder="한센S메카 610호" v-model="profile_user_address2">
							</td>
						</tr>
						<tr>
							<th>핸드폰 번호</th>
							<td>
								<input type="text" v-model="profile_user_phone" placeholder="010-0000-1000">
							</td>
						</tr>
						<tr>
							<th>중개사업자 등록번호</th>
							<td>
								<input type="text" v-model="profile_user_regi_num" placeholder="000-00-00000">
							</td>
						</tr>
					</tbody>
				</table>
...
export default {
	...
	data() {
		return {
			...
			profile_user_address1: '',
			profile_user_address2: '',
	...
	methods: {
		...
		selectAddr: function (data) {
			this.lat = data.x;
			this.lon = data.y;
			this.profile_user_address1 = data.road;
		...
		getAddress: function () {
			...
			if (this.profile_user_address1.length > 0) {
				var url = this.url_address + "&query=" + this.profile_user_address1 + "&type=address&size=1000"
				url += "&category=ROAD"
		...
		saveUser: function () {
			if (this.profile_pwd.length > 0
				&& this.profile_pwd_confirm.length > 0
				&& this.profile_email.length > 0
				&& this.profile_user_address1.length > 0
				&& this.profile_user_address2.length > 0
				&& this.profile_user_company.length > 0
				&& this.profile_user_lastName.length > 0
				&& this.profile_user_firstName.length > 0) {

				var sendData = {
					CustomerFirstName: this.profile_user_firstName,
					CustomerLastName: this.profile_user_lastName,
					CustomerEmail: this.profile_email,
					CustomerAddress1: this.profile_user_address1,
					CustomerAddress2: this.profile_user_address2,
					ContactPhoneNumber: this.profile_user_phone,
					RegistrationNumber: this.profile_user_regi_num,
					CustomerCompanyName: this.profile_user_company
				};
		...
		recvSaveUser: function (data, textStatus, jqXHR) {
			...
			this.profile_pwd = '';
			this.profile_pwd_confirm = '';
			this.profile_user_company = '';
			this.profile_user_address1 = '';
			this.profile_user_address2 = '';
			this.profile_user_phone = '';
			this.profile_user_regi_num = '';
			this.profile_user_lastName = '';
			this.profile_user_firstName = '';
