...
import siteMonitor from '~/components/siteMonitor.vue'
...
export default{
    ...
    head:{
        script: [
            ...
            { src: "https://www.amcharts.com/lib/4/geodata/vietnamLow.js" },
    ...
    components: 
    {
        statusTop,statusBottom,siteMonitor,
    },
    beforeDestroy() {
    ...
    methods:{
        ...
        measurementData(){
            ...
            for(var i = 0; i< resp.length; i++){
                ...
                resource.push({
                    ...
                    sumOfPvPower : Number(resp[i].pvgeneration/1000).toFixed(3),
                })
        ...
        initMap(){
            var chart = am4core.create("dashboardMap", am4maps.MapChart);
...
.main_cont_wrap .local_info_chart > li {
