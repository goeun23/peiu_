<template>
  ...
  <div class="dashboard_wrap">
    ...
    <div class="dashboard_box">
      <strong class="title"
        ><a href="#"
          >일반계약관리<i class="xi-angle-up" aria-hidden="true"></i></a
      ></strong>
      <div class="conts">
        <div class="inquiry">
          <div class="selectbox">
        ...
        <div id="normalContractDialog" class="modal">
          <div class="modal-content">
            <span class="close-button" @click="closeDlg('normalContractDialog')"
              >&times;</span
            >
        ...
        <div id="newContractDlg" class="modal">
          <div class="modal-content">
            <span class="close-button" @click="closeDlg('newContractDlg')"
              >&times;</span
            >
            <form id="newContractDlg_form" action="">
              <table class="data_table center">
                ...
                <tbody>
                  ...
                  <tr>
                    <th>계약종료일</th>
                    <td>
                      <input type="date" name="contractEndDT" id="" required />
                    </td>
                  </tr>
                </tbody>
              </table>
              <div class="modal_btn_div">
                <input
                  type="button"
                  value="Save"
                  @click="saveContract('newContractDlg_form')"
                />
              </div>
            </form>
          </div>
            ...
            <table class="data_table center">
              ...
              <tbody>
                <tr v-for="row in normalContracts" v-bind:key="row.id">
                  ...
                  <td>
                    <button
                      @click="openNormalContractDlg(row.idx)"
                      class="btn_detail"
                    >
                      상세보기
                    </button>
    ...
    <div class="dashboard_box">
      <strong class="title"
        ><a href="#"
          >자원계약관리<i class="xi-angle-up" aria-hidden="true"></i></a
      ></strong>
      <div class="conts">
        <div class="inquiry">
          <div class="selectbox">
          ...
          <dl class="period">
            ...
            <dd>
              ...
              <p class="btn_inguiry"><a href="#">조회</a></p>
              <p class="btn_inguiry">
                <a href="#" @click="open_dlg('res_contract_dialog')"
                  >신규계약</a
                >
              </p>
            </dd>
        ...
        <div id="res_contract_dialog" class="modal">
          <div class="modal-content">
            <span class="close-button" @click="closeDlg('res_contract_dialog')"
              >&times;</span
            >
            <form id="res_contract_dialog_form" action="">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <input
                        type="date"
                        name="res_contract_start_dt"
                        id="res_contract_start_dt"
                        required
                      />
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td>
                      <input
                        type="date"
                        name="res_contract_end_dt"
                        id="res_contract_end_dt"
                        required
                      />
                    </td>
                  </tr>
              ...
              <div class="modal_btn_div">
                <input
                  type="button"
                  value="Save"
                  @click="save_dlg('res_contract_dialog_form')"
                />
              </div>
            </form>
          </div>
            ...
            <table class="data_table center">
              ...
              <tbody>
                <tr v-for="row in res_contrancs_data" v-bind:key="row.id">
                  ...
                  <td>
                    <span>{{ row.pvAmount }}</span>
                  </td>
                  <td>
                    <span>{{ row.essAmount }}</span>
                  </td>
                  <td>
                    <span>{{ row.drAmount }}</span>
                  </td>
                  <td>
                    <button
                      @click="
                        open_res_detail_dialog('res_contract_dialog', row.idx)
                      "
                      class="btn_detail"
                    >
                      상세보기
    ...
    <div class="dashboard_box bid_box">
      <strong class="title"
        ><a href="#"
          >입찰낙찰관리<i class="xi-angle-up" aria-hidden="true"></i></a
      ></strong>
      ...
      <div class="conts">
        <div class="inquiry">
          ...
          <dl class="period">
            ...
            <dd>
              ...
              <p class="btn_inguiry"><a href="#">조회</a></p>
              <p class="btn_inguiry">
                <a href="#" @click="open_dlg('bid_dialog')">입찰</a>
              </p>
        ...
        <div id="bid_dialog" class="modal">
          <div class="modal-content">
            <span class="close-button" @click="closeDlg('bid_dialog')"
              >&times;</span
            >
            <form id="bid_dialog_form" action="">
              ...
              <div class="modal_btn_div">
                <input
                  type="button"
                  value="Save"
                  @click="save_dlg('bid_dialog_form')"
                />
              </div>
            </form>
          </div>
    ...
    <div class="dashboard_box">
      <strong class="title"
        ><a href="#">휴일관리<i class="xi-angle-up" aria-hidden="true"></i></a
      ></strong>
      <div class="conts">
        <div class="inquiry">
          <dl class="period">
            ...
            <dd>
              <p class="btn_inguiry">
                <a href="#" @click="open_dlg('holi_dialog')">추가</a>
              </p>
            </dd>
          </dl>
        </div>
        <div id="holi_dialog" class="modal">
          <div class="modal-content">
            <span class="close-button" @click="closeDlg('holi_dialog')"
              >&times;</span
            >
            <form id="holi_dialog_form" action="">
              ...
              <div class="modal_btn_div">
                <input
                  type="button"
                  value="Save"
                  @click="save_dlg('holi_dialog_form')"
                />
              </div>
            </form>
          </div>
...
export default {
  ...
  methods: {
    ...
    openNormalContractDlg: function (idx) {
      document
        .getElementById("normalContractDialog")
