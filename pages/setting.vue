  ...
  <div>
    ...
    <div class="cont_body">
      <div class="tab_wrap size1">
        <div class="tab_tit">
          <ul>
            <li id="adm" @click="clickMenu('adm')" class="is_active">
              <a class="btn_tab_tit"><span>사용자관리</span></a>
            </li>
            <li id="msg" @click="clickMenu('msg')">
              <a class="btn_tab_tit"><span>건의사항</span></a>
            </li>
            <li id="info" @click="clickMenu('info')">
              <a class="btn_tab_tit"><span>관리자정보</span></a>
            </li>
