    ...
    <div class="top_switch_zone">
      <div class="switch_zone_l">
        <button
          ...
          id="toggle"
          type="button"
          class="switch_land_island on_land"
        >
          <span></span>
        </button>
      </div>
    ...
    <div class="area_map_wrap">
      ...
      <div class="area_sel">
        ...
        <div class="area_size_btn">
          <button @click="hideLayer()" type="button">
            <span class="hide">사이즈수정</span>
          </button>
        </div>
      </div>
      <!-- map_view -->
      <div class="map_view" id="land">
        <!-- 확대된 넓이 :  164.4rem, 축소된 넓이 : 130rem -->
        <div class="map_size_btn_set">
          <button type="button" onclick="CtrlMap('+')" class="btn_size_plus">
            <span class="hide">확대</span>
          </button>
          <button type="button" onclick="CtrlMap('-')" class="btn_size_minus">
            <span class="hide">축소</span>
          </button>
        </div>
      </div>
      <div class="map_view" id="island">
        <!-- 확대된 넓이 :  164.4rem, 축소된 넓이 : 130rem -->
        <div class="map_size_btn_set">
          <button
            type="button"
            onclick="CtrlMap_jeju('+')"
            class="btn_size_plus"
          >
            <span class="hide">확대</span>
          </button>
    ...
    drawDivIcon(key, depth, siteid, rcc) {
      ...
      if (depth == 1) {
        ...
        t =
          ...
          ">" +
          "<span class='tit'> " +
          this.$t("regionStatus.actviepower") +
          ": </span>" +
          "<span class='txt " +
          actpwr +
          "'" +
          "></span>" +
          "<span class='tit'> | " +
          this.$t("regionStatus.eventCount") +
          ": </span>" +
          "<span class='txt " +
          evt +
          "'" +
        ...
        t =
          ...
          "'" +
          "></li>" +
          "<li><span class='tit'>SOC : </span><span class='txt " +
          soc +
          "'" +
          "></li>" +
          "<li><span class='tit'>" +
