		...
		<nav class="gnb_wrap">
			...
			<div class='gnb'>
				<ul class="page_move">
					...
					<a @click="clickMenu('/main', '메인페이지')" id="gnav-main" class="home ">
						<span></span>
					</a>
				<ul>
                    <li id="menu_gismap">
					...
					<li id="menu8">
                        <a @click="clickMenu('/stat', '통계/이력조회')" id="menu8" class="menuStyle btnCursor">
					 ...
					 <li id="menu11">
						<a @click="clickMenu('/market','마켓')" class="menuStyle btnCursor">
							<span>{{$t("menu.market")}}</span>
						</a>
					</li>
					<li id="menu12">
						<a @click="clickMenu('/SearchEvent', '이벤트')" id="menu12" class="menuStyle btnCursor">
							<span>{{$t("menu.event")}}</span>
						</a>
					</li>
					<li id="menu14">
						<a @click="clickMenu('/report', '보고서')" id="menu14" class="menuStyle btnCursor">
		...
		<div class="header_info_wrap">
			...
			<div class="set_info">
				<ul>
					...
					<li>
						<a href="#" class="set_info2" @click="logout()">
							
						</a>
					</li><!-- 비활성화시 a태그에 is_disable 클래스 추가 -->
				</ul>
			</div>
		</div>
	</div>
