...
function initPage(gridId, pagerId, pI, pit){
 ...
 if(pageList<2){
  ...
  pageInner+=`<span class='customPageMoveBtn'><img src="/images/page/page-left-arrow2.png"></span>`;
  pageInner+=`<span class='customPageMoveBtn'><img src="/images/page/page-left-arrow1.png"></span>`;
 }
 ...
 if(pageList>1){
  ...
  pageInner+=`<span class='customPageMoveBtn'><a class='first' href='javascript:firstPage("`+ gridId +`");' title='`+ titleFirstPage +`'><img src="/images/page/page-left-arrow2.png"></a></span>`;
  pageInner+=`<span class='customPageMoveBtn'><a class='pre' href='javascript:prePage("`+ gridId +`");' title='`+ titlePrePage +`'><img src="/images/page/page-left-arrow1.png"></a></span>;`
 }
 ...
 if(totalPageList>pageList){
  // var titleNextPage = (startPageList+10) + " from " + (endPageList+10) + "페이지까지 이동";
  var titleNextPage = (startPageList+10) + " from " + (endPageList+10) + "";
  var titleLastPage = "Last Page";
  ...
  pageInner+=`<span class='customPageMoveBtn'><a class='next' href='javascript:nextPage("`+ gridId +`");' title='`+ titleNextPage +`'><img src="/images/page/page-right-arrow2.png"></a></span>`;
  pageInner+=`<span class='customPageMoveBtn'><a class='last' href='javascript:lastPage("`+ gridId +`");' title='`+ titleLastPage +`'><img src= "/images/page/page-right-arrow1.png"></a></span>`;
 }
 ...
 if(totalPageList==pageList){
  ...
  pageInner+=`<span class='customPageMoveBtn'><img src="/images/page/page-right-arrow2.png"></span>`;
  pageInner+=`<span class='customPageMoveBtn'><img src="/images/page/page-right-arrow1.png"></span>`;
 }   
 //alert(pageInner);
 ...
 if(customPageInfo){
  ...
  if(totalSize == 0){
   ...
   var totpTxt = "Total " + commify(totalPage) + " Page" + " / " + commify(totalSize) + " 개";
   var pseTxt = "( " + commify(from) + " ~ " + commify(to) + " )";
   var totTxt = totpTxt+ " of " + pseTxt;
