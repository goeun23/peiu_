...
function errorpoup(msg) {
  ...
  var btnCont =
    '<button type="button" onKeyDown="javascript:onkeydown();" onclick="javascript:confirmAlert();" class="btn btn_size_free btn_color_blue"><span>확인</span></button>';

  var alertBody =
    '<div tabindex="0"  id="alert_wrap" class="alert_ico_typ1 alert_btn_typ1">';
...
function initMarkerImg() {
  ...
  markerImgMap.set(
    "mImg1",
    L.icon({
      iconUrl: "/images/contents/ico_main_marker1.svg",
      iconSize: [20, 30]
    })
  ); // 경기
  markerImgMap.set(
    "mImg2",
    L.icon({
      iconUrl: "/images/contents/ico_main_marker3.svg",
      iconSize: [20, 30]
    })
  ); // 인천
  markerImgMap.set(
    "mImg3",
    L.icon({
      iconUrl: "/images/contents/ico_main_marker5.svg",
      iconSize: [20, 30]
    })
  ); // 서울
  markerImgMap.set(
    "mImg4",
    L.icon({
      iconUrl: "/images/contents/ico_main_marker7.svg",
      iconSize: [20, 30]
    })
  ); // 대전
  markerImgMap.set(
    "mImg5",
    L.icon({
      iconUrl: "/images/contents/ico_main_marker9.svg",
      iconSize: [20, 30]
    })
  ); // 충남
  markerImgMap.set(
    "mImg6",
    L.icon({
      iconUrl: "/images/contents/ico_main_marker11.svg",
      iconSize: [20, 30]
    })
  ); // 전북
  markerImgMap.set(
    "mImg7",
    L.icon({
      iconUrl: "/images/contents/ico_main_marker13.svg",
      iconSize: [20, 30]
    })
  ); // 전남
  markerImgMap.set(
    "mImg8",
    L.icon({
      iconUrl: "/images/contents/ico_main_marker15.svg",
      iconSize: [20, 30]
    })
  ); // 광주
  markerImgMap.set(
    "mImg9",
    L.icon({
      iconUrl: "/images/contents/ico_main_marker2.svg",
      iconSize: [20, 30]
    })
  ); // 강원
  markerImgMap.set(
    "mImg10",
    L.icon({
      iconUrl: "/images/contents/ico_main_marker4.svg",
      iconSize: [20, 30]
    })
  ); // 충북
  markerImgMap.set(
    "mImg11",
    L.icon({
      iconUrl: "/images/contents/ico_main_marker6.svg",
      iconSize: [20, 30]
    })
  ); // 경북
  markerImgMap.set(
    "mImg12",
    L.icon({
      iconUrl: "/images/contents/ico_main_marker8.svg",
      iconSize: [20, 30]
    })
  ); // 대구
  markerImgMap.set(
    "mImg13",
    L.icon({
      iconUrl: "/images/contents/ico_main_marker10.svg",
      iconSize: [20, 30]
    })
  ); // 울산
  markerImgMap.set(
    "mImg14",
    L.icon({
      iconUrl: "/images/contents/ico_main_marker12.svg",
      iconSize: [20, 30]
    })
  ); // 부산
  markerImgMap.set(
    "mImg15",
    L.icon({
      iconUrl: "/images/contents/ico_main_marker14.svg",
      iconSize: [20, 30]
    })
  ); // 경남
  markerImgMap.set(
    "mImg16",
    L.icon({
      iconUrl: "/images/contents/ico_main_marker16.svg",
      iconSize: [20, 30]
    })
  ); // 제주
...
function initMarkerLoc() {
  ...
  markerLoc.set(2, { lat: 37.47491, lng: 126.598097, rcc: 2 }); //인천
  ...
  markerLoc.set(10, {
    lat: 36.72473031116381,
    lng: 127.83198952674866,
    rcc: 10
  }); //충북
  markerLoc.set(11, {
    lat: 36.52669712203727,
    lng: 128.67660641670227,
    rcc: 11
  }); //경북
  markerLoc.set(12, {
    lat: 35.85920854499696,
    lng: 128.62467885017395,
    rcc: 12
  }); //대구
  markerLoc.set(13, { lat: 35.593456, lng: 129.23628, rcc: 13 }); //울산
